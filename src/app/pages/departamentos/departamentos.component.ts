...
export class DepartamentosComponent implements OnInit {
  ...
  public departamentos: Estado[] = [];
  public size = 20;
  public totalRecords = 0;
  public departamento: Estado = new Estado();
  ...
  public editarDepartamento(departamaento: Estado) {
    this.departamento = departamaento;
    this.esNuevo = false;
    this.habilitarVentana = true;
  }

  public confirmarEliminar(event: Event, departamento: Estado) {
  ...
  private eliminarDepartamento(departamento: Estado) {
