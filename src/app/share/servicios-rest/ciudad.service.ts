...
export class CiudadService {
  ...
  public buscarTodasLasCiudades(idUsuario: number): Observable<StandardResponse> {
    return this.http.get(`${urlBase}ciudad/consulta-suscripcion/${idUsuario}`, httpOptions);
  }
